                    ...
                    <div class="flex">
                        ...
                        <nav class="hidden md:ml-8 md:flex md:space-x-4">
                            ...
                            <a href="{{ route('admin.orders.index') }}" 
                               class="inline-flex items-center px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.orders.*') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-indigo-600' }}">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
