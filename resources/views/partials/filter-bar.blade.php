        ...
        <form method="GET" action="{{ route('tours.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="relative">
                ...
                <input type="text" 
                       ...
                       data-search-url="{{ route('tours.search') }}"
                       autocomplete="off"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                
                {{-- AJAX Search Results Dropdown --}}
                <div id="search-dropdown" 
                     class="hidden absolute z-50 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200 max-h-96 overflow-y-auto">
